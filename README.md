...
MACD: Checks specific crossover logic (Signal Line > MACD).

Volume Spike: Current volume is higher than the 14-period average volume (Volume > Volume Avg 14).

## 🛠️ Installation
* **1. Clone the Repository
git clone [https://github.com/jacopomino/quant-stock-screener-py.git](https://github.com/jacopomino/quant-stock-screener-py.git)
...
## 💻 Usage
* **1. Prepare your Input File: Create a file named etf.csv inside azioni/CSVInput/.
